 ...
 * Struktur baris meniru tabel: arsip_pendidikan, arsip_penelitian, arsip_pengabdian, arsip_penunjang.
 */
?>
<style>
        ...
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500">Pangkalan data tridharma jurusan: pendidikan, penelitian, pengabdian, dan penunjang — data dummy (HTML) untuk pengembangan tampilan.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="mb-4">
        <div class="flex flex-wrap items-center gap-2 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
            <div class="relative flex-1 min-w-[200px]">
                ...
                <input type="search" id="fCari" placeholder="Cari judul, ketua, dosen, jurusan…"
            ...
            <div class="max-h-[560px] overflow-auto">
                    ...
                    <table class="w-full min-w-[820px] text-left text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr class="bg-white transition hover:bg-orange-50" data-tahun="2022" data-cari="sk dosen penerima pnbp 2022 yasin mohamad">
                                ...
                                <td class="py-4 pr-5"><a href="#" class="btn-circle bg-emerald-500 text-white shadow-sm hover:bg-emerald-600"><i class="fas fa-download text-xs"></i><span class="tip">Unduh (dummy)</span></a></td>
                            </tr>
                    ...
                    <table class="w-full min-w-[920px] text-left text-sm">
                        <thead class="sticky top-0 z-10 bg-slate-900 text-xs text-white">
                            <tr>
                                ...
                                <th class="py-3.5 px-4 font-semibold uppercase tracking-wider">Ketua</th>
                                <th class="py-3.5 pr-5 font-semibold uppercase tracking-wider">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-slate-100">
                            <tr class="bg-white transition hover:bg-sky-50" data-tahun="2017" data-cari="pengembangan algoritma optimasi koloni semut dan neuro fuzzy pada penjejakan multi target mandiri ifan wiranto">
                                ...
                                <td class="px-4 py-4 text-slate-600">Ifan Wiranto, ST., MT.</td>
                                <td class="py-4 pr-5"><a href="#" class="btn-circle bg-emerald-500 text-white shadow-sm hover:bg-emerald-600"><i class="fas fa-download text-xs"></i><span class="tip">Unduh (dummy)</span></a></td>
                            </tr>
                            <tr class="bg-slate-50/60 transition hover:bg-sky-50" data-tahun="2017" data-cari="aplikasi jaringan sensor nirkabel dalam perancangan prototipe otomatisasi penerangan rumah mandiri 75000000 wrastawa ridwan">
                            ...
                            <tr class="bg-white transition hover:bg-sky-50" data-tahun="2021" data-cari="rancang bangun prototipe sistem informasi destinasi wisata budaya berbasis kalender musim gorontalo tahun ketiga dalam negeri 150000000 amirudin yunus dako">
                                ...
                                <td class="px-4 py-4 text-slate-600">Amirudin Yunus Dako, ST., M.Eng.</td>
                                <td class="py-4 pr-5"><a href="#" class="btn-circle bg-emerald-500 text-white shadow-sm hover:bg-emerald-600"><i class="fas fa-download text-xs"></i><span class="tip">Unduh (dummy)</span></a></td>
                            </tr>
                            <tr class="bg-slate-50/60 transition hover:bg-sky-50" data-tahun="2020" data-cari="rancang bangun prototipe sistem informasi destinasi wisata budaya berbasis kalender musim gorontalo tahun kedua dalam negeri 150000000 amirudin yunus dako">
                            ...
                            <tr class="bg-white transition hover:bg-sky-50" data-tahun="2019" data-cari="rancang bangun prototipe sistem informasi destinasi wisata budaya berbasis kalender musim gorontalo dalam negeri 150000000 amirudin yunus dako">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-sky-50" data-tahun="2017" data-cari="rancang bangun prototipe sistem informasi kalender musim berbasis kearifan lokal masyarakat gorontalo mandiri amirudin yunus dako">
                            ...
                            <tr class="bg-white transition hover:bg-sky-50" data-tahun="2016" data-cari="rancang bangun prototipe sistem informasi kalender musim berbasis kearifan lokal masyarakat gorontalo mandiri amirudin yunus dako">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-sky-50" data-tahun="2023" data-cari="sistem monitoring kualitas udara berbasis iot di kawasan pesisir teluk gorontalo luar pt 120000000 ervan hasan harun erfan hasan">
                            ...
                            <tr class="bg-white transition hover:bg-sky-50" data-tahun="2022" data-cari="deteksi dini kecurangan akademik menggunakan metode machine learning mandiri lanto kamil amali">
                                ...
                                <td class="px-4 py-4"><span class="inline-flex items-center rounded-full bg-sky-100 px-2.5 py-1 text-xs font-bold text-sky-700">Mandiri/UNG</span></td>
                                <td class="px-4 py-4 text-slate-600">&mdash;</td>
                                <td class="px-4 py-4 text-slate-600">Dr. Lanto M. Kamil Amali, ST., MT.</td>
                                <td class="py-4 pr-5"><a href="#" class="btn-circle bg-emerald-500 text-white shadow-sm hover:bg-emerald-600"><i class="fas fa-download text-xs"></i><span class="tip">Unduh (dummy)</span></a></td>
                            </tr>
                            <tr class="bg-slate-50/60 transition hover:bg-sky-50" data-tahun="2021" data-cari="optimasi penjadwalan perkuliahan menggunakan algoritma genetika luar pt 85000000 zainudin bonok">
                            ...
                            <tr class="bg-white transition hover:bg-sky-50" data-tahun="2020" data-cari="pemodelan numerik distribusi tegangan pada jaringan distribusi cerdas mandiri salmawaty tansa">
                                ...
                                <td class="px-4 py-4"><span class="inline-flex items-center rounded-full bg-sky-100 px-2.5 py-1 text-xs font-bold text-sky-700">Mandiri/UNG</span></td>
                                <td class="px-4 py-4 text-slate-600">&mdash;</td>
                                <td class="px-4 py-4 text-slate-600">Salmawaty Tansa, ST., M.Eng.</td>
                                <td class="py-4 pr-5"><a href="#" class="btn-circle bg-emerald-500 text-white shadow-sm hover:bg-emerald-600"><i class="fas fa-download text-xs"></i><span class="tip">Unduh (dummy)</span></a></td>
                            </tr>
                            <tr class="bg-slate-50/60 transition hover:bg-sky-50" data-tahun="2018" data-cari="sistem pakar diagnosa gangguan jaringan komputer berbasis web mandiri yasin mohamad">
                            ...
                            <tr class="bg-white transition hover:bg-sky-50" data-tahun="2019" data-cari="rancang bangun alat pendeteksi kebocoran gas lpg berbasis iot luar pt 50000000 ervan hasan harun">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-sky-50" data-tahun="2023" data-cari="penerapan teknologi blockchain untuk keamanan arsip akademik mandiri lanto kamil amali">
                ...
                <div class="tab-panel" id="panel-pengabdian">
                    <table class="w-full min-w-[980px] text-left text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr class="bg-white transition hover:bg-emerald-50" data-tahun="2022" data-cari="sosialisasi penggunaan kwh meter jenis digital dan analog pada masyarakat di desa dutohe barat kab bone bolango mandiri yasin mohamad teknik elektro">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-emerald-50" data-tahun="2021" data-cari="pengelolaan bumdes di desa pinomon tiga berbasis web mandiri 7000000 yasin mohamad teknik informatika">
                            ...
                            <tr class="bg-white transition hover:bg-emerald-50" data-tahun="2016" data-cari="pendampingan teknisi listrik instalasi penerangan dasar bagi karang taruna dan masyarakat pengangguran di desa alata karya kec kwandang kab gorontalo utara mandiri 5000000 ervan hasan harun teknik elektro">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-emerald-50" data-tahun="2021" data-cari="pengelolaan bumdes di desa pinomontiga berbasis web mandiri 7000000 yasin mohamad teknik informatika">
                            ...
                            <tr class="bg-white transition hover:bg-emerald-50" data-tahun="2021" data-cari="pengelolaan potensi desa dengan pemanfaatan tik dan transformasi digital untuk peningkatan umkm dan bumdes desa botutonuo kec kabila bone kab bone bolango mandiri 7000000 zainudin bonok teknik informatika">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-emerald-50" data-tahun="2018" data-cari="optimalisasi dan penguatan desa tangguh bencana melalui pemberdayaan sampah organik dan anorganik menjadi kompos dan bbm di kec dulupi dan botumoito kab boalemo mandiri 25000000 salmawaty tansa teknik elektro">
                            ...
                            <tr class="bg-white transition hover:bg-emerald-50" data-tahun="2023" data-cari="pelatihan instalasi listrik rumah tangga bagi remaja di desa molamahu luar pt 50000000 wrastawa ridwan teknik elektro">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-emerald-50" data-tahun="2023" data-cari="bimbingan teknis digitalisasi administrasi desa untuk aparatur kec telaga mandiri ifan wiranto teknik informatika">
                            ...
                            <tr class="bg-white transition hover:bg-emerald-50" data-tahun="2022" data-cari="pemanfaatan iot untuk penerangan jalan umum tenaga surya di desa bongo dalam negeri 120000000 amirudin yunus dako teknik elektro">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-emerald-50" data-tahun="2021" data-cari="sosialisasi dan pelatihan e commerce bagi umkm di kota gorontalo mandiri lanto kamil amali teknik informatika">
                            ...
                            <tr class="bg-white transition hover:bg-emerald-50" data-tahun="2020" data-cari="pendampingan keamanan instalasi listrik di sekolah dasar dan madrasah mandiri salmawaty tansa teknik elektro">
                            ...
                            <tr class="bg-slate-50/60 transition hover:bg-emerald-50" data-tahun="2022" data-cari="workshop pembuatan media pembelajaran digital bagi guru smk luar pt 45000000 zainudin bonok teknik elektro">
                            ...
                            <tr class="bg-white transition hover:bg-emerald-50" data-tahun="2023" data-cari="pemberdayaan kelompok tani melalui sistem informasi pertanian berbasis web mandiri ervan hasan harun teknik informatika">
