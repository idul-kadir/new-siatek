<?php
/**
 * Halaman dummy untuk: Matakuliah MBKM
    ...
    <section class="mb-4">
        <div class="page-header-card">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="mb-1">Matakuliah MBKM</h4>
                    <p class="text-muted mb-0" style="font-size:.85rem;">Matakuliah program Merdeka Belajar Kampus Merdeka (MBKM).</p>
                </div>
            </div>
        </div>
    </section>
