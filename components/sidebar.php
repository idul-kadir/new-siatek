    ...
    <nav class="flex-1 overflow-y-auto py-3 space-y-0.5 px-2">
        ...
        <div>
            ...
            <div class="nav-submenu <?= $jurusanActive ? 'open' : '' ?>" id="sub-jurusan">
                ...
                <a href="/redesain-siatek/jurusan-surat-penunjukkan" class="sub-item flex items-center space-x-3 px-4 py-2 rounded-r-lg text-[13px] transition <?= $activePage === 'jurusan-surat-penunjukkan' ? 'nav-active' : 'nav-item' ?>"><i class="fas fa-file-signature w-5 text-center text-sm opacity-70"></i><span>Surat Penunjukkan</span></a>
